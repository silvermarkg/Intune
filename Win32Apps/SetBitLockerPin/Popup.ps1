...
# - 07/05/2022 Mark Goodman (@silvermarkg): Moved adding TpmPin protector to this script.
#              Deals with issue when parent script terminates and no need to pass PIN via encrypted file 
# - 08/08/2022 Mark Goodman (@silvermarkg): Added 1223 exit code when user cancels prompt and ensure correct exit code is returned
...
$buttonSetPIN_Click = {
	...
	if ($textboxNewPin.Text -eq $textboxRetypedPin.Text) {
		...
		<#
    **** No need to pass PIN back to calling script via encrypted file as PIN protector added in this script ****
    ...
    # Set TpmPin protector
    Add-BitLockerKeyProtector -MountPoint $env:SystemDrive -Pin $(ConvertTo-SecureString -String $textboxNewPin.Text -AsPlainText -Force) -TpmAndPinProtector
